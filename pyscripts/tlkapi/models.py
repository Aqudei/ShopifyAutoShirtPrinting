...
class LineItem(models.Model):
    Id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    OrderNumber = models.TextField(db_column='OrderNumber', blank=True, null=True)  # Field name made lowercase.
    ...
    FinancialStatus = models.TextField(db_column='FinancialStatus', blank=True, null=True)  # Field name made lowercase.
    Customer = models.TextField(db_column='Customer', blank=True, null=True)  # Field name made lowercase.
    CustomerEmail = models.TextField(db_column='CustomerEmail', blank=True, null=True)  # Field name made lowercase.
    ...
    PrintedQuantity = models.IntegerField(db_column='PrintedQuantity')  # Field name made lowercase.
...
class OrderInfoViewSet(models.Model):
    ...
    LabelPrinted = models.BooleanField(db_column='LabelPrinted')  # Field name made lowercase.
    LabelData = models.TextField(db_column='LabelData', blank=True, null=True)  # Field name made lowercase.
    TrackingNumber = models.TextField(db_column='TrackingNumber', blank=True, null=True)  # Field name made lowercase.
    InsuranceCost = models.FloatField(db_column='InsuranceCost')  # Field name made lowercase.
    ShipmentCost = models.FloatField(db_column='ShipmentCost')  # Field name made lowercase.

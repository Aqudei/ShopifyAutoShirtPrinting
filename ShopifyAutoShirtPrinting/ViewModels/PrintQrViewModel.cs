...
namespace ShopifyEasyShirtPrinting.ViewModels
{
    internal class PrintQrViewModel : BindableBase, IDialogAware
    {
        ...
        public void OnDialogOpened(IDialogParameters parameters)
        {
            ...
            var selectedItems = parameters.GetValue<IEnumerable<OrderItem>>("selectedItems");
            var orderItems = selectedItems as OrderItem[] ?? selectedItems.ToArray();
        ...
        public string Title => "Print QR Codes";
